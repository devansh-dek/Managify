...
function GoogleCalendar() {
  return (
    <div className="bg-[#51576D] w-fit p-5 m-3 rounded-[20px]">
      ...
      <iframe
        ...
        src="https://calendar.google.com/calendar/embed?height=600&wkst=1&ctz=Asia%2FKolkata&bgcolor=%23E67C73&showTitle=0&showNav=0&mode=AGENDA&showDate=0&showTabs=0&showPrint=0&showCalendars=0&showTz=0&src=a3VtYXJhbnViaGF2MjAwMjZAZ21haWwuY29t&src=Y2xhc3Nyb29tMTEzMDUxNjAwNzQwNzMxOTAwNjc1QGdyb3VwLmNhbGVuZGFyLmdvb2dsZS5jb20&src=YWRkcmVzc2Jvb2sjY29udGFjdHNAZ3JvdXAudi5jYWxlbmRhci5nb29nbGUuY29t&src=Y2xhc3Nyb29tMTExNDMzOTg3Njc4Nzg3OTI5MDAzQGdyb3VwLmNhbGVuZGFyLmdvb2dsZS5jb20&src=ZW4uaW5kaWFuI2hvbGlkYXlAZ3JvdXAudi5jYWxlbmRhci5nb29nbGUuY29t&color=%23039BE5&color=%23007b83&color=%2333B679&color=%230047a8&color=%230B8043"
        width="750"
        height="550"
        frameBorder="0"
        scrolling="no"
